...
2. If no logo provided: generate with `nc-ai-multimodal` workflow
3. Screenshot wireframes with `nc-chrome-devtools` → save to `./docs/wireframes/`
...
Activate **nc-plan** skill: `/nc-plan --fast <requirements>`

...
Activate the nc-chrome-devtools skill.
...
## Workflow
- follow the `nc-plan` workflow to organize the test plan & report
...
- Use `nc-ai-multimodal` to analyze all screenshots
- Generate comprehensive Markdown report
- Ask user if they want to preview with `/nc-preview`

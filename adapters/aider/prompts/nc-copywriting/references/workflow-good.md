...
1. **Screenshots provided** → follow the `nc-ai-multimodal` workflow for detailed context analysis
2. **Videos provided** → Use `nc-ai-multimodal` video-analysis for comprehensive context

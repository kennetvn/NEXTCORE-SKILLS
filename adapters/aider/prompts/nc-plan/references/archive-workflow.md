...
### Step 2: Summarize the plans and document them with `/nc-journal` skill invocation
...
- Stage and commit the changes (Use `/nc-git` for commit flow)
- Commit and push the changes (Use `/nc-git` for push flow)

...
- Otherwise use `nc-repomix` to generate fresh codebase summary
- Use `/nc-scout` or `/nc-scout ext` to find relevant files
- follow the `nc-docs-seeker` workflow for package/plugin documentation

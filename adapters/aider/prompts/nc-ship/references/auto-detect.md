...
**If NONE:** Use chat question — "No test runner detected. Options: A) Skip tests, B) Provide test command"
...
User explicitly says "breaking" or "major feature" → chat question for minor/major
```

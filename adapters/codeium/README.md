...
Ports NEXTCORE skills to Codeium IDE.

## Codeium specifics

Codeium is a free AI coding assistant with prompt support in VS Code/JetBrains

- **Prompts** live in `.codeium/prompts/*.md`
...
Automated:
```bash
curl -sSL https://raw.githubusercontent.com/kennetvn/NEXTCORE-SKILLS/main/install.sh | bash -s -- --ide=codeium
```

Windows PowerShell:
```powershell
iwr -useb https://raw.githubusercontent.com/kennetvn/NEXTCORE-SKILLS/main/install.ps1 | iex -Args '-Ide codeium'
```

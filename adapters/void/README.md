...
Ports NEXTCORE skills to Void IDE.

## Void specifics

Void is an open-source fork of VS Code with native AI support

- **Prompts** live in `.void/prompts/*.md`
...
Windows PowerShell:
```powershell
iwr -useb https://raw.githubusercontent.com/kennetvn/NEXTCORE-SKILLS/main/install.ps1 | iex -Args '-Ide void'
```

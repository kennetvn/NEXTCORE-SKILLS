...
Workflow for Claude Design — Anthropic's prototype/slide/mockup generator that reads your codebase + design system. Use when preparing a repo for Claude Design ingestion, exporting outputs to production code, or deciding when Claude Design fits vs traditional design tools.

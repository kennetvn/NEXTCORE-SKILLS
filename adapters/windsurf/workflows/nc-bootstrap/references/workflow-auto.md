...
3. If no logo provided: generate with `nc-ai-multimodal` workflow
4. Screenshot wireframes with `nc-chrome-devtools` → save to `./docs/wireframes/`
...
Activate **nc-plan** skill: `/nc-plan --auto <requirements>`
...
Activate **nc-cook** skill: `/nc-cook --auto <plan-path>`

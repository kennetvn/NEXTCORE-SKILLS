...
| *(none + no context)* | Prompt | ask user via chat question |
...
When no arguments and no recent context, use chat question:
- Header: "Review Target"
- Question: "What would you like to review?"
- Options: Pending changes, Enter PR number, Enter commit hash, Full codebase scan, Parallel codebase audit

For PR/commit options, follow up with second chat question to get the number/hash.

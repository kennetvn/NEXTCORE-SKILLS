...
**All workflows**: Activate `nc:ui-ux-pro-max` skill FIRST for design intelligence.
...
1. **Analyze** with `nc:ai-multimodal` skill - extract colors, fonts, spacing, effects

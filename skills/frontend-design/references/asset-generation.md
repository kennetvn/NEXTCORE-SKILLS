...
Complete workflow for generating design-aligned visual assets using `nc:ai-multimodal` skill.
...
Use `nc:ai-multimodal` skill's image generation capabilities:
...
4. Consider using `nc:media-processing` skill for post-generation adjustments

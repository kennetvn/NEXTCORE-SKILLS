...
## Prerequisites
- Activate `nc:ui-ux-pro-max` skill first
- Activate `nc:threejs` skill for 3D and WebGL expertise
- Have `nc:ai-multimodal` skill ready for asset generation
...
Use `nc:ai-multimodal` skill for:
- Textures and materials
- Skyboxes and environment maps
- Particle sprites
- Video backgrounds

Use `nc:media-processing` skill for:

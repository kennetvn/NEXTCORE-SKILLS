...
## Prerequisites
- Activate `nc:ui-ux-pro-max` skill first for design intelligence
- Have `nc:ai-multimodal` skill ready for visual analysis

## Workflow Steps

### 1. Analyze Screenshot Details
Use `nc:ai-multimodal` skill to extract:

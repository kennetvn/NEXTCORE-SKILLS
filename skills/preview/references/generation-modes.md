...
When generating mermaid code blocks, use `/nc:mermaidjs-v11` skill for v11 syntax rules.
...
For `--slides`: recommend invoking `/nc:ui-ux-pro-max` for richer style selection.
Must use `/nc:mermaidjs-v11` for any Mermaid diagrams.

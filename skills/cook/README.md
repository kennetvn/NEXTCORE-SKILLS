...
/nc:cook implement user authentication

# Execute existing plan
/nc:cook plans/260120-auth

# Fast mode (skip research)
/nc:cook quick fix for login bug
/nc:cook implement feature --fast

# Auto mode (trust me bro)
/nc:cook implement dashboard trust me
/nc:cook implement feature --auto

# Parallel mode (multi-agent)
/nc:cook implement auth, payments, notifications
/nc:cook implement feature --parallel

# No-test mode
/nc:cook implement feature --no-test
```

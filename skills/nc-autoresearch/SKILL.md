...
# nc:autoresearch — Autonomous Optimization Loop
...
|-----------|-------------|
| Subjective goals ("make it cleaner") | `nc:cook` |
| Bug fixing with known root cause | `nc:fix` or `nc:debug` |
| One-shot tasks, no repetition needed | `nc:cook` |
| No mechanical metric to measure progress | `nc:cook --interactive` |

...
- `/nc:kanban` - View dashboard for ./plans directory
- `/nc:kanban <dir>` - View dashboard for specific directory
- `/nc:kanban --stop` - Stop running server
...
The `/nc:kanban` command will evolve into **VibeKanban-inspired** AI agent orchestration:
...
Track progress: https://github.com/nextcoreskill/nextcoreskill-engineer/issues/189

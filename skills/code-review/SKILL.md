...
| **Checklist review** | Pre-landing, `/nc:ship` pipeline, security audit | `references/checklist-workflow.md` |
...
|------------|-----------|---------|
| `/nc:code-review codebase` | `references/codebase-scan-workflow.md` | Scan & analyze the codebase |
| `/nc:code-review codebase parallel` | `references/parallel-review-workflow.md` | Ultrathink edge cases, then parallel verify |

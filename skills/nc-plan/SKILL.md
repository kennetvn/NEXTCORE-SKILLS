...
|------------|-----------|---------|
| `/nc:plan archive` | `references/archive-workflow.md` | Archive plans + write journal entries |
| `/nc:plan red-team` | `references/red-team-workflow.md` | Adversarial plan review with hostile reviewers |
| `/nc:plan validate` | `references/validate-workflow.md` | Validate plan with critical questions interview |

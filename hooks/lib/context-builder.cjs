...
function buildRulesSection({ devRulesPath, skillsVenv, plansPath, docsPath }) {
  ...
  // Agent Board — mandatory first step before any work
  lines.push(`- **[MANDATORY FIRST STEP]** Read \`<storage-project>/agent-infra/board/BOARD.md\` before ANY work. Create checkin file. Update BOARD.md. No exceptions.`);

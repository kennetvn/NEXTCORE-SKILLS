...
- **System Architecture** (`./docs/system-architecture.md`): Technical architecture, component interactions, and infrastructure design
- **Code Standards** (`./docs/code-standards.md`): Coding conventions, naming rules, and quality guidelines

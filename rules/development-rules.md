...
## Visual Aids
- Use `/nc:preview --explain` when explaining unfamiliar code patterns or complex logic
- Use `/nc:preview --diagram` for architecture diagrams and data flow visualization
- Use `/nc:preview --slides` for step-by-step walkthroughs and presentations
- Use `/nc:preview --ascii` for terminal-friendly diagrams (no browser needed to understand)
